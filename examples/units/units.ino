#/**
 * @file units.ino
 * @brief Example: Demonstrate the TinyRobotics units module for distance, angle, speed, and time.
 *
 * This example shows how to use the TinyRobotics unit classes to represent and convert
 * between different physical units (distance, angle, speed, and time) in embedded robotics code.
 *
 * ## Features
 * - Demonstrates construction and conversion of Distance, Angle, Speed, and Time objects
 * - Shows how to print values in different units
 * - Useful for verifying unit conversion logic and as a reference for integrating units in your own code
 *
 * ## Usage
 * - Open the Serial Monitor at 115200 baud to see the output.
 * - Adapt or extend the code to test other unit conversions as needed.
 *
 *
 * @author pschatzmann
 */
